...
class TypTest: AnnotationSpec() {
    ...
    fun attackGestein(): Attack{
        return Attack(attackName = "Gestein",
            type = Typ.Gestein,
            damage=50,
            damageQuote = 50,
            specialAttack = false
    ...
    fun attackStahl():Attack{
        return Attack(attackName = "Stahl",
            type = Typ.Stahl,
            damage=50,
            damageQuote = 50,
            specialAttack = false
    ...
    fun attackGeist():Attack{
        return Attack(attackName = "Geist",
            type = Typ.Geist,
            damage=50,
            damageQuote = 50,
            specialAttack = false
    ...
    fun attackNormal():Attack{
        return Attack(attackName = "Normal",
            type = Typ.Normal,
            damage=50,
            damageQuote = 50,
            specialAttack = false
    ...
    fun attackUnlicht():Attack{
        return Attack(attackName = "Unlicht",
            type = Typ.Unlicht,
            damage=50,
            damageQuote = 50,
            specialAttack = false
    ...
    fun attackKaefer():Attack{
        return Attack(attackName = "Kaefer",
            type = Typ.Kaefer,
            damage=50,
            damageQuote = 50,
            specialAttack = false
    ...
    fun attackPsycho():Attack{
        return Attack(attackName = "Psycho",
            type = Typ.Psycho,
            damage=50,
            damageQuote = 50,
            specialAttack = false
    ...
    fun attackKampf():Attack{
        return Attack(attackName = "Kampf",
            type = Typ.Kampf,
            damage=50,
            damageQuote = 50,
            specialAttack = false
    ...
    fun attackPflanze():Attack{
        return Attack(attackName = "Pflanze",
            type = Typ.Pflanze,
            damage=50,
            damageQuote = 50,
            specialAttack = false
    ...
    fun attackElektro():Attack{
        return Attack(attackName = "Elektro",
            type = Typ.Elektro,
            damage=50,
            damageQuote = 50,
            specialAttack = false
    ...
    fun attackBoden():Attack{
        return Attack(attackName = "Boden",
            type = Typ.Boden,
            damage=50,
            damageQuote = 50,
            specialAttack = false
    ...
    fun attackFeuer():Attack{
        return Attack(attackName = "Feuer",
            type = Typ.Feuer,
            damage=50,
            damageQuote = 50,
            specialAttack = false
    ...
    fun attackWasser():Attack{
        return Attack(attackName = "Wasser",
            type = Typ.Wasser,
            damage=50,
            damageQuote = 50,
            specialAttack = false
    ...
    fun attackDrache():Attack{
        return Attack(attackName = "Drache",
            type = Typ.Drache,
            damage=50,
            damageQuote = 50,
            specialAttack = false
