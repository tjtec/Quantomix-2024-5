...
class BattleTest : AnnotationSpec() {
    ...
    fun `Battletest with normal Attack`() {
        ...
        Assertions.assertThat(schillok.kp).isEqualTo(41)
    }
    @Test
    fun `Batteltest with special Attack Type 2`() {
        ...
        battle.newKp(attack)
        Assertions.assertThat(glurak.kp).isEqualTo(78)
        Assertions.assertThat(schillok.kp).isEqualTo(31)
    }
    @Test
    fun `Batteltest with other Quantomix and special Attack Type 1`() {
        ...
        battle.newKp(attack)
        Assertions.assertThat(glurak.kp).isEqualTo(61)
    ...
    fun `Batteltest extrem effectiviness`() {
        ...
        battle.newKp(attack)
        Assertions.assertThat(glurak.kp).isEqualTo(78)
        Assertions.assertThat(owei.kp).isEqualTo(32)
    }
    @Test
    fun `Batteltest less effectiviness`() {
        ...
        battle.newKp(attack)
        Assertions.assertThat(glurak.kp).isEqualTo(78)
        Assertions.assertThat(owei.kp).isEqualTo(51)
    }
    @Test
    fun `Batteltest effectiviness`() {
        ...
        battle.newKp(attack)
        Assertions.assertThat(glurak.kp).isEqualTo(78)
        Assertions.assertThat(owei.kp).isEqualTo(42)
        }
    @Test
    fun `Batteltest not effectiv`() {
        ...
        battle.newKp(attack)
        Assertions.assertThat(glurak.kp).isEqualTo(78)
        Assertions.assertThat(rattfratz.kp).isEqualTo(30)
    }
}