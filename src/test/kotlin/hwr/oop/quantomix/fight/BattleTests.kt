...
class BattleTests : AnnotationSpec() {
    ...
    fun `BattleTest extrem effectiviness and less effectiviness`() {
        ...
        assertThat(oweiBattleStats.getStats().getKp()).isEqualTo(owei.getStats().getKp())
        assertThat(glurakBattleStats.getStats().getAttack()).isEqualTo(glurak.getStats().getAttack())
        assertThat(oweiBattleStats.getStats().getDefense()).isEqualTo(owei.getStats().getDefense())
        assertThat(glurakBattleStats.getStats().getSpeed()).isEqualTo(glurak.getStats().getSpeed())
        assertThat(oweiBattleStats.getStats().getSpeed()).isEqualTo(owei.getStats().getSpeed())
        assertThat(glurakBattleStats.getStats().getSpecialAttack()).isEqualTo(glurak.getStats().getSpecialAttack())
        assertThat(oweiBattleStats.getStats().getSpecialAttack()).isEqualTo(owei.getStats().getSpecialAttack())
        assertThat(glurakBattleStats.getStats().getSpecialDefense()).isEqualTo(glurak.getStats().getSpecialDefense())
        assertThat(oweiBattleStats.getStats().getSpecialDefense()).isEqualTo(owei.getStats().getSpecialDefense())
        val solution=battle.simpleBattle(
            aktiveQuantomixBattleStats = glurakBattleStats,
            attack = pfluecker(),
