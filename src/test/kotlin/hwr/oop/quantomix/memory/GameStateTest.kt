...
class GameStateTest : AnnotationSpec() {
    ...
    fun `Test Save and Load`() {
        ...
        Assertions.assertThat(loadedTrainer1?.coachName).isEqualTo(trainer1.coachName)
        Assertions.assertThat(loadedTrainer2?.coachName).isEqualTo(trainer2.coachName)
        Assertions.assertThat(loadedTrainer1?.quantomixTeam?.get(1)?.getType1()).isEqualTo(trainer1.quantomixTeam.get(1).getType1())
        Assertions.assertThat(filePath).isEqualTo("game_state.json")
        Assertions.assertThat(loadedBattleStatsMap?.size).isEqualTo(battleStatsMap.size)
